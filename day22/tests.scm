...
(test-equal 1 (range-size (make-range 1 2 (list (make-range 3 4 (list (make-range 5 6 #t)))))))
(test-equal 1000 (range-size (make-range 0 10 (list (make-range 20 30 (list (make-range -10 0 #t)))))))
